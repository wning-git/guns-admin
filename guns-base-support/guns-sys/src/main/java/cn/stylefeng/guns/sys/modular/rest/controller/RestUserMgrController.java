...
@Tag(name = "RestUserMgrController", description = "用户管理API接口")
public class RestUserMgrController extends BaseController {
     ...
     * @Date 2018/12/24 22:43
     */
    @RequestMapping(path = "/changePwd", method = RequestMethod.PUT)
     ...
     * @Date 2018/12/24 22:44
     */
    @RequestMapping(path = "/changeStatus", method = RequestMethod.PUT)
     ...
     * @Date 2018/12/24 22:44
     */
    @RequestMapping(path = "/setRole", method = RequestMethod.PUT)
